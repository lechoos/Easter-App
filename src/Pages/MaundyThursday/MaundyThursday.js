...
const MaundyThursday = () => {
	...
	const sentences = [
		...
		'Na Mszy Krzyżma, na której gromadzi się duchowieństwo danej diecezji razem ze swoim biskupem święcone są oleje.',
		'Podczas Mszy Wieczerzy Pańskiej kapłan obmywa nogi 12 mężczyznom.',
		`W ${state.year} roku Wielki Czwartek wypada ${dayNumber} ${month}.`
	];
